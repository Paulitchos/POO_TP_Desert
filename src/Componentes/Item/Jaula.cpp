...
void Jaula::execute(shared_ptr<Caravana> car, Barbaro *bar) {
    if (car != nullptr) {
        ...
        if (espacoDisponivel <= 0) {
            cout << "Apanhou o item " << getNome() << " mas caravana ja atingiu o limite maximo de tripulantes." <<
                    endl;
            return;
        }
        ...
        cout << "Apanhou o item " << getNome() << " foram adicionados " << espacoDisponivel <<
                " tripulantes a caravana " << car->getID() << endl;
    ...
    if (bar != nullptr) {
        ...
        if (espacoDisponivel <= 0) {
            cout << "Apanhou o item " << getNome() << " mas caravana barbara ja atingiu o limite maximo de tripulantes."
                    << endl << endl;
            return;
        }
        ...
        cout << "Apanhou o item " << getNome() << " foram adicionados " << espacoDisponivel <<
                " tripulantes a caravana barbara" << endl << endl;
    }
}
